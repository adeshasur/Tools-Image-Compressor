...
export default function ImageCompressor() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Standard Floating Navbar */}
      <nav className="relative z-10 pt-10 px-4 flex justify-center">
        <div className="w-full max-w-[50rem] nav-glass h-[74px] flex items-center justify-between px-8 rounded-[40px]">
          <span className="text-[15px] font-semibold text-[#111111]">
            Adheesha Sooriyaarachchi
          </span>
          <a 
            href="https://info-adheesha.vercel.app/"
            className="btn-slate text-[13px] font-medium px-6 py-2.5 shadow-sm"
          >
            Back to Portfolio
          </a>
        </div>
      ...
      {/* Main Content Area: Cardless Columns */}
      <main className="relative z-10 max-w-4xl mx-auto mt-20 px-8 pb-32">
        <div className="flex flex-col md:flex-row gap-16 md:gap-0">
          ...
          <div className="flex-1 md:pr-20 md:content-separator flex flex-col min-h-[480px]">
            <div className="mb-10">
              <h2 className="text-[14px] font-semibold text-[#111111] mb-2">Original Asset</h2>
              <p className="text-[13px] text-[#222222]/40 font-medium">Auto-calibrating while you adjust parameters.</p>
            </div>
            ...
            >
              {originalFile ? (
                <div className="flex flex-col items-center text-center">
                   ...
                   <p className="text-[12px] font-medium text-[#222222]/40 mb-10">{formatSize(originalFile.size)}</p>
                   
                   <button 
                     onClick={() => setOriginalFile(null)}
                     className="flex items-center gap-2 text-[12px] font-semibold text-[#ce3c3c] hover:opacity-70 transition-opacity"
                   >
                ...
                <div className="flex flex-col items-center text-center">
                   ...
                   <p className="text-[13px] text-[#222222]/40 font-medium max-w-[180px] leading-relaxed mb-10">
            ...
            <div className="mt-8 flex items-center gap-3 py-4 px-6 rounded-2xl bg-[#111111]/[0.02] border border-[#111111]/[0.03]">
               ...
               <p className="text-[12px] text-[#222222]/40 font-medium leading-normal">
          ...
          <div className="flex-1 md:pl-20 flex flex-col justify-center min-h-[480px]">
            <div className="mb-10">
              <h2 className="text-[14px] font-semibold text-[#111111] mb-2">Live Compression</h2>
              <p className="text-[13px] text-[#222222]/40 font-medium">Fine-tune the fidelity of your output asset.</p>
            </div>

            <div className="space-y-12 flex-grow">
               <div className="space-y-4">
                  <div className="flex items-center justify-between">
                     <span className="text-[13px] font-bold text-[#111111]">Quality Level</span>
                     <span className="text-[13px] font-bold text-[#111111]">{Math.round(quality * 100)}%</span>
                  </div>
                  <input 
                    type="range"
                    min="0.1"
                  ...
                  />
                  <div className="flex justify-between text-[11px] font-medium text-[#222222]/30">
               ...
               <div className="p-8 rounded-[2rem] border border-[#111111]/[0.04] bg-white/30 space-y-6">
                  <div className="flex justify-between items-start">
                     <div>
                        <p className="text-[11px] font-bold text-[#222222]/20 uppercase tracking-widest mb-1">Savings</p>
                     ...
                     <div className="text-right">
                        <p className="text-[11px] font-bold text-[#222222]/20 uppercase tracking-widest mb-2">Cycle</p>
                        <span className={`text-[10px] font-bold px-3 py-1.5 rounded-full ${compressedFile && !compressing ? "bg-[#111111] text-white" : "bg-[#111111]/5 text-[#111111]/20"}`}>
                  ...
                  <div className="pt-6 border-t border-[#111111]/5 grid grid-cols-2 gap-8">
                     <div>
                        <p className="text-[10px] font-bold text-[#222222]/20 uppercase tracking-widest mb-1">Source</p>
                        <p className="text-[13px] font-semibold text-[#111111]/40 tracking-tight">{originalFile ? formatSize(originalFile.size) : "---"}</p>
                     </div>
                     <div>
                        <p className="text-[10px] font-bold text-[#222222]/20 uppercase tracking-widest mb-1">Result</p>
            ...
            <button
               ...
               className="group relative w-full h-[64px] bg-[#111111] text-white rounded-[1.25rem] flex items-center justify-center gap-3 text-[14px] font-semibold shadow-lg shadow-[#111111]/10 hover:shadow-xl hover:translate-y-[-1px] active:scale-[0.98] transition-all disabled:opacity-20 disabled:translate-y-0 disabled:shadow-none"
            >
               {compressing ? "Processing Asset..." : "Download Optimized Asset"}
